...
# Draw 72mm wide Edge.Cuts (Centered at X=45.0 -> Left 9.0, Right 81.0)
...
draw_line(9.0, 0.0, 81.0, 0.0)
draw_line(81.0, 0.0, 81.0, -138.0)
draw_line(81.0, -138.0, 9.0, -138.0)
draw_line(9.0, -138.0, 9.0, 0.0)

# Re-position Buttons to fit in 72mm
spacing = 11.5 # Adjusted spacing for 72mm width
C1 = 45.0 - 2.5 * spacing
C2 = 45.0 - 1.5 * spacing
C3 = 45.0 - 0.5 * spacing
C4 = 45.0 + 0.5 * spacing
...
print("Set 72mm PCB Width, adjusted button spacing, cleared tracks.")
