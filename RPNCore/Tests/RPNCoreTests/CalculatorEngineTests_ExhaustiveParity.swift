...
final class CalculatorEngineTests_ExhaustiveParity: XCTestCase {
    ...
    func testExhaustiveParity() {
        let testCases: [(name: String, keys: [String], expected: Double)] = [
            ...
            ("Square Root", ["1", "6", "√𝑥"], 4.0),
            ("Natural Log", ["2", "LN"], log(2)),
            ("Reciprocal", ["4", "1/𝑥"], 0.25),
            ("Sign Toggle", ["5", "+/-"], -5.0),
            ("Exponent (e^x)", ["1", "𝑒ˣ"], exp(1)),
            ("Base 10 Exponent", ["2", "10ˣ"], 100.0),
            ("Power (y^x)", ["2", "ENTER", "3", "𝑦ˣ"], 8.0),
            ("Swap x<>y", ["1", "ENTER", "2", "ENTER", "3", "𝑥≷𝑦"], 2.0),
