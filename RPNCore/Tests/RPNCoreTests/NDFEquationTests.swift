...
final class NDFEquationTests: XCTestCase {
    ...
    // Simulate creating the NDF equation via the Firmware physical buttons (RetroUIController)
    func testFirmwareNDFEquationCreation() {
        ...
        XCTAssertEqual(engine.currentEquationLabel, "N")
    ...
    // Simulate creating the NDF equation via iOS/watchOS UI (Direct Engine Calls)
